...
export default function AlgorithmDetail() {
  ...
  const fetchAIExplanation = async () => {
    ...
    try {
      const data = await apiFetch<{
        ...
        method: 'POST',
        body: JSON.stringify({ algorithm: algoName, dataSize }),
      });
      setAiData(data);
    } catch {
  ...
  return (
    <div className="h-full min-h-0 flex flex-col xl:flex-row gap-6 p-4 animate-in fade-in overflow-hidden">
       ...
       <div className="flex-1 min-h-0 flex flex-col gap-6">
          ...
          <div className="flex-1 min-h-0 flex flex-col">
             <div className="flex-1 min-h-[70vh] rounded-[3rem] overflow-hidden shadow-[0_0_50px_rgba(0,0,0,0.5)] border border-slate-800">
                <AlgoPreviewVisualizer algoName={algoName} showControls={true} isLarge={true} dataSize={dataSize} />
             </div>
          </div>
       </div>

       <div className="xl:w-[450px] w-full min-h-0 flex flex-col gap-6 overflow-y-auto custom-scrollbar">
            ...
            {!aiData ? (
              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                 ...
                 <div>
                    ...
                    <div className="mb-4">
                      <AlgoPreviewVisualizer algoName={algoName} dataSize={dataSize} />
                    </div>
