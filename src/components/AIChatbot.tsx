...
export default function AIChatbot() {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: 'start', sender: 'ai', text: 'Hi! I am your AI academic tutor. You can ask me any algorithm questions, or simply share how you are feeling today.' }
  ]);
    ...
    setTimeout(() => {
      if (isStressed) {
        ...
        const aiMsg: ChatMessage = {
          ...
          sender: 'ai',
          text: `That's a great question about algorithms! Generally, if you are working with sorted data, binary search is O(log n). Let me know if you need a deeper explanation on ${input.split(' ')[0]}!`
        };
