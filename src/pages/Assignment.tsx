...
function getGuide(courseId: string): StudyGuide {
  ...
  if (course.difficulty === 'Expert') return GUIDES.default_expert;
  if (course.difficulty === 'Advanced') return GUIDES.default_advanced;
  if (course.difficulty === 'Intermediate') return GUIDES.default_intermediate;
  return GUIDES.default_beginner;
}
