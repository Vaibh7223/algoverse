...
export const MOCK_COURSES: Course[] = [
  // BEGINNER
  {
    ...
    ytId: 'RBSGKlAvoiM',
    description: 'A rapid overview of arrays, linked lists, trees, and graphs — perfect for beginners.',
    difficulty: 'Beginner',
    xp: 100,
    duration: '3h 20m',
  ...
  },
  {
    ...
    thumbnail: 'https://img.youtube.com/vi/V6mKVRU1evU/mqdefault.jpg',
    ytId: 'V6mKVRU1evU',
    description: 'Understand time and space complexity from scratch with easy visual examples.',
    difficulty: 'Beginner',
    xp: 80,
    duration: '1h 45m',
    topics: ['Time Complexity', 'Space Complexity', 'Big-O', 'Big-Theta'],
    badge: 'bronze',
  },
  {
    id: '3',
    title: 'Recursion Masterclass',
    thumbnail: 'https://img.youtube.com/vi/IJDJ0kBx2LM/mqdefault.jpg',
    ytId: 'IJDJ0kBx2LM',
    description: 'Conquer recursion from base cases to tree recursion and memoization.',
    difficulty: 'Beginner',
    xp: 120,
    duration: '2h 10m',
    topics: ['Base Cases', 'Call Stack', 'Tree Recursion', 'Memoization'],
    badge: 'bronze',
  },
  // INTERMEDIATE
  {
    ...
    thumbnail: 'https://img.youtube.com/vi/0IAPZzGSbME/mqdefault.jpg',
    ytId: '0IAPZzGSbME',
    description: 'Deep dive into algorithmic complexity, sorting, and dynamic programming.',
    difficulty: 'Intermediate',
    xp: 250,
    duration: '5h 00m',
    topics: ['Sorting', 'Searching', 'Divide & Conquer', 'DP'],
    badge: 'silver',
  },
  {
    id: '5',
    ...
    ytId: 'g-PGLbMth_g',
    description: 'Merge Sort, Quick Sort, Heap Sort — visualized and compared side by side.',
    difficulty: 'Intermediate',
    xp: 200,
    duration: '2h 30m',
    topics: ['Merge Sort', 'Quick Sort', 'Heap Sort', 'Radix Sort'],
    badge: 'silver',
  },
  {
    id: '6',
    title: 'Graph Algorithms Bootcamp',
    thumbnail: 'https://img.youtube.com/vi/tWVWeAqZ0WU/mqdefault.jpg',
    ytId: 'tWVWeAqZ0WU',
    description: 'BFS, DFS, Dijkstra, and Bellman-Ford — master every graph traversal technique.',
    difficulty: 'Intermediate',
    xp: 300,
    duration: '4h 15m',
  ...
  {
    id: '7',
    title: 'Springboard: Coding Interview Prep',
    thumbnail: 'https://img.youtube.com/vi/pkYVOmU3MgA/mqdefault.jpg',
    ytId: 'pkYVOmU3MgA',
    description: 'Comprehensive bootcamp covering data structures, algorithms, and technical interviews.',
    difficulty: 'Intermediate',
    xp: 280,
    duration: '3h 50m',
    topics: ['Arrays', 'Hash Maps', 'Trees', 'System Design Basics'],
    badge: 'silver',
  },
  // ADVANCED
  {
    ...
    ytId: 'oBt53YbR9Kk',
    description: 'Tackle every DP problem archetype: knapsack, LCS, matrix chain, and more.',
    difficulty: 'Advanced',
    xp: 500,
    duration: '5h 45m',
    topics: ['Knapsack', 'LCS', 'Matrix Chain', 'Bitmask DP'],
    badge: 'gold',
  },
  {
    id: '9',
    title: 'IBM: Advanced Algorithms & Data Structures',
    thumbnail: 'https://img.youtube.com/vi/8hly31xKli0/mqdefault.jpg',
    ytId: '8hly31xKli0',
    description: 'Professional certificate series focusing on enterprise-scale algorithmic problem solving.',
    difficulty: 'Advanced',
    xp: 450,
    duration: '6h 00m',
    topics: ['Red-Black Trees', 'B-Trees', 'Skip Lists', 'Bloom Filters'],
    badge: 'gold',
  },
  {
    id: '10',
    title: 'Backtracking & Branch-and-Bound',
    thumbnail: 'https://img.youtube.com/vi/A80YzvNwqXA/mqdefault.jpg',
    ytId: 'A80YzvNwqXA',
    description: 'Solve N-Queens, Sudoku, graph coloring and TSP using backtracking strategies.',
    difficulty: 'Advanced',
    xp: 420,
    duration: '4h 30m',
    topics: ['N-Queens', 'Sudoku Solver', 'Graph Coloring', 'TSP'],
    badge: 'gold',
    locked: true,
  },
  // EXPERT
  {
    ...
    thumbnail: 'https://img.youtube.com/vi/YX40hbAHx3s/mqdefault.jpg',
    ytId: 'YX40hbAHx3s',
    description: 'Explore the boundaries of computation: P vs NP, reductions, and approximation algorithms.',
    difficulty: 'Expert',
    xp: 800,
    duration: '7h 20m',
    topics: ['P vs NP', 'Cook-Levin', 'Approximation', 'Randomized Algos'],
    badge: 'platinum',
    locked: true,
  },
  {
    ...
    thumbnail: 'https://img.youtube.com/vi/GjpufJoemgs/mqdefault.jpg',
    ytId: 'GjpufJoemgs',
    description: 'Advanced competitive techniques: segment trees, lazy propagation, FFT, and flow networks.',
    difficulty: 'Expert',
    xp: 1000,
    duration: '8h 00m',
    topics: ['Segment Trees', 'FFT', 'Max Flow', 'String Matching'],
    badge: 'platinum',
    locked: true,
  },
];
                    ...
                    >
                      ...
                      {course.locked && !isCompleted && (
                        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-slate-950/70 backdrop-blur-sm rounded-2xl">
                          ...
                          <p className="text-slate-300 font-bold text-sm">Complete previous courses</p>
                          <p className="text-slate-500 text-xs">to unlock this</p>
                        </div>
                      )}
                      ...
                      <div className="p-5 flex-1 flex flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-auto">
                          <Link
                            ...
                            className={`flex-1 py-2 rounded-xl text-sm font-bold text-center transition-all duration-200 ${course.locked
